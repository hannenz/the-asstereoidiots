(function($) {
    jQuery.fn.html5_upload = function(options) {
		...
		form.find('input').each(function(i, el){
			if ($(el).attr('name') && $(el).attr('name').substr(0, 4) == 'data'){
        ...
        function upload() {
            ...
            var $this = $(this);
            if (!$this.triggerHandler('html5_upload.onStart', [files])) {
                return false;
            }
            this.disabled = true;
            var uploaded = 0;
        ...
        return this.each(function() {
            ...
            $(this)
                ...
                .bind('html5_upload.cancelAll', function() {
					console.log('received cancelAll event. Aborting all uploads');
